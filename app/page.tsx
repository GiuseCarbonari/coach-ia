...
/**
 * Landing pubblica. L'account Limina e il collegamento a Intervals.icu
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-8 bg-base px-4 py-10">
      <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
        <svg width="56" height="56" viewBox="0 0 58 58" fill="none" aria-label="Limina logo">
          <circle
            cx="29" cy="29" r="22"
            stroke="url(#lgLmk)"
            strokeWidth="5"
        ...
        <p className="max-w-xl text-lg text-secondary">
          ...
          account Limina e collega Intervals.icu per ricevere ogni giorno una
          decisione chiara e un programma costruito sui tuoi dati reali.
        </p>
      </div>

      <Button asChild size="lg">
        <a href="/login">Accedi a Limina</a>
      </Button>
